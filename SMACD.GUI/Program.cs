...
namespace SMACD.GUI
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            ExtensionToolbox.Instance.LoadExtensionLibrariesFromPath(Path.Combine(Directory.GetCurrentDirectory(), "Plugins"),
                    "SMACD.Plugins.*.dll");
        ...
        {
            return ExtensionToolbox.Instance.ExtensionLibraries.Select(
