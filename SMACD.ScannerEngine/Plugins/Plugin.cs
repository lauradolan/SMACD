...
namespace SMACD.ScannerEngine.Plugins
{
    ...
    {
        private PluginPointerModel _pointer;
        ...
        /// <summary>
        /// Pointer that created this Plugin instance
        /// </summary>
        public PluginPointerModel Pointer
        {
            get => _pointer;
            set
            {
                _pointer = value;
                ConfigureLoggerDefault();
            }
        }

        /// <summary>
        /// Working directory to contain all artifacts generated by this plugin
        /// </summary>
        public string WorkingDirectory { get; set; }

        protected Plugin() => ConfigureLoggerDefault();
        ...
        private void ConfigureLoggerDefault()
        {
            if (Pointer != null && Pointer.Plugin != null)
            {
                if (Pointer.Resource != null)
                    Logger = Global.LogFactory.CreateLogger(Pointer.Plugin + "@" + Pointer.Resource.ResourceId);
                else
                    Logger = Global.LogFactory.CreateLogger(Pointer.Plugin);
            }
            else
